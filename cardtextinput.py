...
<M_CardTextField>:
    ...
    MDCard:
        ...
        CustomTextInput:
            ...
            grow: True
            initial_height: 0
            filter_input: root.filter_input
            focus: root.focus
            ...
            background_color: app.theme_cls.bg_light # root.background_color
...
class CustomTextInput(TextInput):
    ...
    max_chars = NumericProperty(None, allow_none=True)
    filter_input = OptionProperty('none', options=['alpha','none'])

    def insert_text(self, substring, from_undo=False):
        if self.filter_input == 'alpha':
            if not from_undo and (not substring.isalpha()) and substring != '':
                return
...
class M_CardTextField(MDBoxLayout, RectangularElevationBehavior, ThemableBehavior):
    ...
    elevation = NumericProperty(0, allownone=True)
    ...
    valid_text = StringProperty("")

    max_chars = NumericProperty(None, allow_none=True)

    def __init__(self, **kwargs):
        self.icon_right_widget = MDIconButton(theme_text_color="Custom", text_color=[0, 0, 0, 1], md_bg_color_disabled=[0, 0, 0, 0])
        self.icon_left_widget = MDIconButton(theme_text_color="Custom", text_color=[0, 0, 0, 1], md_bg_color_disabled=[0, 0, 0, 0])
        ...
        if self.grow_card:
            self.multiline = True
        if self.icon_left:
            self.icon_left_widget = MIconButton(
            ...
            self.icon_left_widget.bind(disabled=self.set_d_color)
            self.add_widget(self.icon_left_widget, index=1)
            self.multiline = False

        if self.icon_right:
            self.icon_right_widget = MIconButton(
    ...
    def set_d_color(self, _inst, _val):
        if _val:
            _inst.md_bg_color_disabled=[0, 0, 0, 0]
        

    def on_icon_left(self, _instance, value):
    ...
    def on_icon_left_color(self, _instance, value):
        self.icon_left_widget.text_color = value

    def on_icon_left_font_name(self, _instance, value):
        self.icon_left_widget.font_name = value

    def on_icon_left_callback(self, _instance, value):
        self.icon_left_widget.bind(on_release=value)

    def on_icon_left_font_size(self, _instance, value):
        self.icon_widget.font_size = value

    def on_icon_left_background_color(self, _instance, value):
        self.icon_widget.md_bg_color = value

    def on_icon_right(self, _instance, value):
    ...
    def on_icon_right_color(self, _instance, value):
        self.icon_right_widget.text_color = value

    def on_icon_right_font_name(self, _instance, value):
        self.icon_right_widget.font_name = value

    def on_icon_right_callback(self, _instance, value):
        self.icon_right_widget.bind(on_release=value)

    def on_icon_right_font_size(self, _instance, value):
        self.icon_right_widget.font_size = value

    def on_icon_right_background_color(self, _instance, value):
    ...
    class Opera(MDApp):
        ...
        def build(self):
            ...
            field4 = M_CardTextField(hint_text="text field with left icon & can't grow", grow_card=False,
                                     icon_left="home",
                                     icon_left_color=[0, 0, 1, 1], disabled=True)
        ...
        def search(self, _instance):
            self.theme_cls.theme_style = 'Dark'

        def login(self, _instance):
